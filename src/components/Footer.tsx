        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="https://portal.africtune.ggff.net/#/license-application" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">Apply for License</a></li>
              <li><a href="https://portal.africtune.ggff.net/" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">Login / Register</a></li>
            </ul>
          </div>
